...
const experience = [
  {
    ...
    bullets: [
      {
        text: "Recovered over $100K in inflated point balances across 1,744 users and 4 brands by re-engineering the core credit-debit transaction matching logic in a Python/Flask service and building an idempotent MySQL batch-processing pipeline to restore historical integrity with zero downtime.",
      ...
      {
        text: "Architected an async, event-driven order-rating system for the Kiosk backend in Python/Flask with Redis-backed queues and MySQL, containerized with Docker, decoupling rating submission from order creation so product teams could act on customer feedback directly.",
      ...
      {
        text: "Developed a dual-mode surcharge calculation feature in Python/Flask with MySQL and a React-based store-level admin toggle, for accurate tax and fee reporting across brands and revenue centres.",
  ...
  },
  {
    ...
    bullets: [
      ...
      },
      {
        ...
        skills: ["Cross-Functional Collaboration", "REST API Design"],
      },
      {
      ...
      },
      {
        ...
        skills: ["Sidekiq", "Async Processing", "Distributed Systems", "Redis"],
      },
      {
      ...
      },
      {
        ...
        skills: ["Technical Mentorship", "Unit Testing", "Code Reviews", "REST API Design"],
      },
    ],
    stack: [
      "Ruby on Rails",
